...
- Name: navigation.spec.ts >> Navigation - Dashboard Routes >> should navigate to finance page
...
Call log:
  - waiting for locator('a[href="/dashboard/finance"]')
