...
- Name: navigation.spec.ts >> Redirect - Post-Action >> should redirect to login after session expires
- Location: tests\e2e\navigation.spec.ts:266:7

# Error details

```
TypeError: page.clearCookies is not a function
```
