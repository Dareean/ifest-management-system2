...
- Name: navigation.spec.ts >> Navigation - Meetings Routes >> should filter meetings by status
- Location: tests\e2e\navigation.spec.ts:135:7
...
Call log:
  - waiting for locator('[data-testid="filter-upcoming"]')
