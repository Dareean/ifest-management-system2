...
- Name: navigation.spec.ts >> Navigation - Sidebar >> should highlight active menu item
- Location: tests\e2e\navigation.spec.ts:334:7
...
Locator:  locator('a:has-text("Surat")')
Expected: "page"
Received: ""
Timeout:  15000ms
...
Call log:
  ...
  - waiting for locator('a:has-text("Surat")')
    33 × locator resolved to <a href="/dashboard/letters/new">…</a>
