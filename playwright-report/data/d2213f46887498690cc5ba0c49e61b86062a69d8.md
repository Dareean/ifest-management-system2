...
- Name: navigation.spec.ts >> Navigation - Letters Routes >> should filter by letter status
...
Call log:
  - waiting for locator('[data-testid="filter-requested"]')
