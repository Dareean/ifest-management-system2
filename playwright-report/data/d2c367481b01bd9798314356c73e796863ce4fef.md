...
- Name: navigation.spec.ts >> Navigation - Meetings Routes >> should navigate back to meetings list
- Location: tests\e2e\navigation.spec.ts:129:7
...
Call log:
  - waiting for locator('button:has-text("Batal")')
    ...
    - generic [ref=e55]:
      - banner [ref=e56]:
        - generic [ref=e57]:
          ...
          - generic [ref=e59]: •
          - generic [ref=e60]: 13.39.24
        - button [ref=e62]:
          - img [ref=e63]
      - main [ref=e66]:
        - generic [ref=e67]: Akses ditolak. Role Anda (level 50) tidak mencukupi (min. level 55).
