...
- Name: navigation.spec.ts >> Redirect - Error Pages >> should show error message for invalid input
- Location: tests\e2e\navigation.spec.ts:306:7
...
Locator: locator('text=/tidak ditemukan|not found/i')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('text=/tidak ditemukan|not found/i')
